...
public class Game {
    ...
    public void playMove(MoveOption chosenMove, Player currentPlayer, List<Integer> diceValues) {
        ...
        String dispEnd = (chosenMove.getEndPos() == 25) ? "bear off" : String.valueOf(displayedIndex(currentPlayer, chosenMove.getEndPos()));
    ...
    public void printLegalMovesWithCodes(List<MoveOption> legalMoves) {
        ...
        for (MoveOption move : legalMoves) {
            ...
            String dispEnd = (move.getEndPos() == 25) ? "bear off" : String.valueOf(displayedIndex(currentPlayer, move.getEndPos()));
